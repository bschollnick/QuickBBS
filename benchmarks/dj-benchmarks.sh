...
echo "---------------------------------------------------------------------------------------" >> $1_perf.txt
httperf --server 127.0.0.1 --port 8888 --num-conns 200 --rate 100 --timeout 1 --uri "/albums/verification_suite/benchtests/test1.bin?download" >> $1_perf.txt
echo "---------------------------------------------------------------------------------------" >> $1_perf.txt
httperf --server 127.0.0.1 --port 8888 --num-conns 200 --rate 125 --timeout 1 --uri "/albums/verification_suite/benchtests/test1.bin?download" >> $1_perf.txt
echo "---------------------------------------------------------------------------------------" >> $1_perf.txt
