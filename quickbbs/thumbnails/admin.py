...
class AdminThumbnail_Files(admin.ModelAdmin):
    ...
    list_display = ('id', 'uuid', 'FileName', 'FileSize', 'is_default','SmallThumb', 'MediumThumb', 'LargeThumb')
    fields = ('id', 'FileName', 'FileSize', 'is_default', 'uuid','SmallThumb', 'MediumThumb', 'LargeThumb')#, 'is_pdf', 'is_image')
