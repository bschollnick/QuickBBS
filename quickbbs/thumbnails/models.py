    ...
    * large_thumb - Binary storage for the large thumbnail
    ...
    def get_or_create_thumbnail_record(
        ...
        with transaction.atomic():
            ...
            has_unlinked, _updated_count = FileIndex.link_to_thumbnail(file_sha256, thumbnail)
    ...
    def _resolve_index_item_for_sha(
        ...
        if index_data_item is None:
            ...
            _has_unlinked_fix, updated_count_fix = FileIndex.link_to_thumbnail(file_sha256, thumbnail)
    ...
    def send_thumbnail(
        ...
        filename = filename_override or index_data_item.name if index_data_item else filename_override or "thumbnail"
