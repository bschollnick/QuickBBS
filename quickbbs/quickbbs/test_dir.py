...
print("normalized MD5:",normalize_fqpn(testdir), convert_text_to_md5_hdigest(normalize_fqpn(testdir)))
print("abspath normalized MD5:", os.path.abspath(normalize_fqpn(testdir)), convert_text_to_md5_hdigest(os.path.abspath(normalize_fqpn(testdir))))
