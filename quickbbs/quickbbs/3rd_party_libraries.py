...
DJANGO_HTMX_URI = (
    f"https://cdnjs.cloudflare.com/ajax/libs/htmx/{DJANGO_HTMX_VERSION}/htmx.min.js"
)
...
PDF_JS_VIEWER_URI = (
    f"https://cdnjs.cloudflare.com/ajax/libs/pdf.js/{PDF_JS_VIEWER_VERSION}/pdf.min.js"
)
