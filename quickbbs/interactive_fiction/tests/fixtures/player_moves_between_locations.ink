...
// a converted game does. Step 11 (b): where_is_now("player") must follow the
...
=== foyer ===
~ temp _here = set_location_now("player", "foyer")
You are in the foyer. Player is at: {where_is_now("player")}
+ [Go to the cellar] -> cellar

=== cellar ===
~ temp _here = set_location_now("player", "cellar")
You are in the cellar. Player is at: {where_is_now("player")}
-> DONE
